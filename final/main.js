...
// "continental"
// "mediterranean"
const possibilities = [{type: "A", combo: {temperature: "cool", soil: "stone/gravel", climate: "continental"}}, 
					  {type: "B", combo: {temperature: "cool", soil: "stone/gravel", climate: "mediterranean"}},
					  {type: "C", combo: {temperature: "cool", soil: "sand", climate:"continental"}},
					  {type: "D", combo: {temperature: "cool", soil: "sand", climate: "mediterranean"}},
					  {type: "E", combo: {temperature: "warm", soil: "stone/gravel", climate: "continental"}},
					  {type: "F", combo: {temperature: "warm", soil: "stone/gravel", climate: "mediterranean"}},
					  {type: "G", combo: {temperature: "warm", soil: "sand", climate: "continental"}},
					  {type: "H", combo: {temperature: "warm", soil: "sand", climate: "mediterranean"}}];
